...
export const NODES: ResearchNode[] = [
  // ---- Bú — the household ---------------------------------------------
  { id: "sigd", name: "Sigð", gloss: "sickle", tree: "bu", gen: 1, maxLevel: 5, needs: [],
  ...
  { id: "breidox", name: "Breiðöx", gloss: "broad axe", tree: "bu", gen: 2, maxLevel: 10, needs: ["oxi"],
  ...
  { id: "fleygur", name: "Fleygur", gloss: "splitting wedge", tree: "bu", gen: 2, maxLevel: 10, needs: ["meitill"],
    effect: "Stone, stronger",
    blurb: "Wedges set along the grain and struck in order. The stone opens where you decided." },
  { id: "raudablastur", name: "Rauðablástur", gloss: "bog-iron smelting", tree: "bu", gen: 2, maxLevel: 10, needs: ["raudi"],
    effect: "Iron, stronger",
    blurb: "The turf-and-charcoal furnace that turns bog lumps into a bloom of workable iron." },

  { id: "kvorn", name: "Kvörn", gloss: "the quern", tree: "bu", gen: 3, maxLevel: 10, needs: ["ardr"],
  ...
  { id: "sog", name: "Sög", gloss: "the saw", tree: "bu", gen: 3, maxLevel: 10, needs: ["breidox"],
  ...
  { id: "grjothledsla", name: "Grjóthleðsla", gloss: "dry-stone walling", tree: "bu", gen: 3, maxLevel: 10, needs: ["fleygur"],
  ...
  { id: "smidja", name: "Smiðja", gloss: "the smithy", tree: "bu", gen: 3, maxLevel: 10, needs: ["raudablastur"],
    effect: "Iron, strongest",
    blurb: "The forge at the edge of the yard, where iron stops being a resource and starts being a thing." },

  { id: "busaeld", name: "Búsæld", gloss: "the farm's plenty", tree: "bu", gen: 4, maxLevel: 10, needs: ["kvorn", "sog"],
  ...
  { id: "audlegd", name: "Auðlegð", gloss: "wealth", tree: "bu", gen: 4, maxLevel: 10, needs: ["grjothledsla", "smidja"],
    effect: "All production, a share on top",
  ...
  { id: "torfrista", name: "Torfrista", gloss: "turf-cutting", tree: "handverk", gen: 1, maxLevel: 5, needs: [],
    effect: "Build cost",
  ...
  { id: "timbrsmid", name: "Timbrsmíð", gloss: "carpentry", tree: "handverk", gen: 1, maxLevel: 5, needs: [],
    effect: "Build speed",
    blurb: "Joints cut so they hold without nails. Faster raising of every roof in the hall." },
  { id: "verkfaeri", name: "Verkfæri", gloss: "tools", tree: "handverk", gen: 1, maxLevel: 5, needs: [],
    effect: "All building work",
    blurb: "Auger, adze, draw-knife, plane. Nothing else in this tree happens without them." },
  { id: "bur", name: "Búr", gloss: "the storehouse", tree: "handverk", gen: 1, maxLevel: 5, needs: [],
    effect: "Storage capacity",
    blurb: "The locked room off the hall. What you cannot store, you cannot keep through the winter." },

  { id: "torfhledsla", name: "Torfhleðsla", gloss: "turf-laying", tree: "handverk", gen: 2, maxLevel: 10, needs: ["torfrista", "verkfaeri"],
  ...
  { id: "raftur", name: "Raftur", gloss: "the rafter", tree: "handverk", gen: 2, maxLevel: 10, needs: ["timbrsmid", "verkfaeri"],
  ...
  { id: "skemma", name: "Skemma", gloss: "the outbuilding", tree: "handverk", gen: 2, maxLevel: 10, needs: ["bur"],
    effect: "Storage, stronger",
    blurb: "A second roof away from the hall, for what does not fit under the first." },

  { id: "hornstafur", name: "Hornstafur", gloss: "the corner-post", tree: "handverk", gen: 3, maxLevel: 10, needs: ["raftur"],
  ...
  { id: "fordabur", name: "Forðabúr", gloss: "the provision store", tree: "handverk", gen: 3, maxLevel: 10, needs: ["skemma"],
    effect: "Storage, strongest",
    blurb: "Provisions laid by for a year you cannot see yet. The deepest store a hall can hold." },
  { id: "hlada", name: "Hlaða", gloss: "the barn", tree: "handverk", gen: 3, maxLevel: 10, needs: ["skemma", "torfhledsla"],
  ...
  { id: "handlag", name: "Handlag", gloss: "the knack", tree: "handverk", gen: 4, maxLevel: 10, needs: ["hornstafur", "torfhledsla"],
  ...
  { id: "skali", name: "Skáli", gloss: "the hall", tree: "handverk", gen: 4, maxLevel: 10, needs: ["hornstafur", "fordabur"],
  ...
  { id: "runaristur", name: "Rúnaristur", gloss: "rune-carving", tree: "fraedi", gen: 2, maxLevel: 10, needs: ["fraedi", "stafrof"],
  ...
  { id: "minni", name: "Minni", gloss: "memory", tree: "fraedi", gen: 2, maxLevel: 10, needs: ["fraedi"],
  ...
  { id: "landabref", name: "Landabréf", gloss: "the chart", tree: "fraedi", gen: 2, maxLevel: 10, needs: ["njosn"],
    effect: "Map vision",
    blurb: "A drawn coast is worth a season of guessing. What you can see of the world before you sail into it." },

  { id: "spakmaeli", name: "Spakmæli", gloss: "wise sayings", tree: "fraedi", gen: 3, maxLevel: 10, needs: ["runaristur"],
  ...
  { id: "talnalist", name: "Talnalist", gloss: "the art of numbers", tree: "fraedi", gen: 3, maxLevel: 10, needs: ["runaristur", "minni"],
    effect: "Research cost, strongest",
    blurb: "Reckoning. Less waste in everything counted, which by this point is everything." },
  { id: "ttvisi", name: "Ættvísi", gloss: "knowledge of the line", tree: "fraedi", gen: 3, maxLevel: 10, needs: ["minni"],
  ...
  { id: "ratvisi", name: "Ratvísi", gloss: "the sense of the way", tree: "fraedi", gen: 3, maxLevel: 10, needs: ["landabref"],
  ...
  { id: "visdomur", name: "Vísdómur", gloss: "wisdom", tree: "fraedi", gen: 4, maxLevel: 10, needs: ["spakmaeli", "talnalist"],
  ...
  { id: "sagnaritun", name: "Sagnaritun", gloss: "saga-writing", tree: "fraedi", gen: 4, maxLevel: 10, needs: ["ttvisi", "ratvisi"],
  ...
  // ---- Kaup — the trade -----------------------------------------------
  { id: "reipi", name: "Reipi", gloss: "rope", tree: "kaup", gen: 1, maxLevel: 5, needs: [],
  ...
  { id: "klyfjar", name: "Klyfjar", gloss: "pack-loads", tree: "kaup", gen: 1, maxLevel: 5, needs: [],
  ...
  { id: "vog", name: "Vog", gloss: "the scales", tree: "kaup", gen: 1, maxLevel: 5, needs: [],
    effect: "Trade spread at the Market",
    blurb: "A balance and a set of weights. Being cheated less is the same as earning more." },

  { id: "sledi", name: "Sleði", gloss: "the sledge", tree: "kaup", gen: 2, maxLevel: 10, needs: ["klyfjar", "reipi"],
  ...
  { id: "alin", name: "Alin", gloss: "the ell", tree: "kaup", gen: 2, maxLevel: 10, needs: ["vog"],
  ...
  { id: "vadmal", name: "Vaðmál", gloss: "homespun cloth", tree: "kaup", gen: 2, maxLevel: 10, needs: ["vog", "reipi"],
  ...
  { id: "farmur", name: "Farmur", gloss: "cargo", tree: "kaup", gen: 3, maxLevel: 10, needs: ["sledi"],
    effect: "Carry, strongest",
    blurb: "A full hold, balanced and lashed. What a voyage is actually for." },
  { id: "mork", name: "Mörk", gloss: "the mark", tree: "kaup", gen: 3, maxLevel: 10, needs: ["alin", "vadmal"],
    effect: "Trade rates, strongest",
    blurb: "A weight of silver, and the unit everything else was priced against." },
  { id: "kaupstefna", name: "Kaupstefna", gloss: "the trade meet", tree: "kaup", gen: 3, maxLevel: 10, needs: ["vadmal"],
    effect: "Market options and refresh",
    blurb: "The gathering where prices are made. More to choose from, more often." },

  { id: "kaupmadur", name: "Kaupmaður", gloss: "the merchant", tree: "kaup", gen: 4, maxLevel: 10, needs: ["farmur", "mork"],
  ...
  { id: "kaupangur", name: "Kaupangur", gloss: "the trading place", tree: "kaup", gen: 4, maxLevel: 10, needs: ["mork", "kaupstefna"],
  ...
  // ---- Berg — the rock ------------------------------------------------
  { id: "malmleit", name: "Málmleit", gloss: "prospecting", tree: "berg", gen: 1, maxLevel: 5, needs: [],
    effect: "Chance to spot a vein when surveying", later: true,
    blurb: "Literally metal-searching. Walking ground and knowing what the colour of a broken rock means." },
  { id: "gangur", name: "Gangur", gloss: "the adit", tree: "berg", gen: 1, maxLevel: 5, needs: [],
    effect: "How deep the specialists can work", later: true,
    blurb: "The passage driven in at the hillside. Depth is the whole limit on what a mine is worth." },
  { id: "hamar", name: "Hamar", gloss: "hammer, and crag", tree: "berg", gen: 1, maxLevel: 5, needs: [],
    effect: "Breaking rate", later: true,
  ...
  { id: "malmaed", name: "Málmæð", gloss: "the ore vein", tree: "berg", gen: 2, maxLevel: 10, needs: ["malmleit"],
    effect: "Yield from a worked vein", later: true,
    blurb: "The seam itself, once found. How much of it actually comes out." },
  { id: "grjotnam", name: "Grjótnám", gloss: "quarrying", tree: "berg", gen: 2, maxLevel: 10, needs: ["hamar", "gangur"],
    effect: "Yield, stronger", later: true,
    blurb: "Taking the rock in worked courses rather than breaking at it. The organised version of the same job." },
  { id: "nama", name: "Náma", gloss: "the mine", tree: "berg", gen: 2, maxLevel: 10, needs: ["gangur"],
    effect: "Specialists per expedition", later: true,
    blurb: "How many can work the face at once without being in each other's way." },

  { id: "deigla", name: "Deigla", gloss: "the crucible", tree: "berg", gen: 3, maxLevel: 10, needs: ["malmaed"],
    effect: "Grade of metal recoverable", later: true,
    blurb: "The clay cup that holds metal while fire decides what it is. Better crucible, better metal." },
  { id: "sindur", name: "Sindur", gloss: "slag", tree: "berg", gen: 3, maxLevel: 10, needs: ["nama", "grjotnam"],
    effect: "Waste reduction", later: true,
    blurb: "The glassy waste at the bottom of the furnace. Less of it means more of everything else." },

  { id: "malmur", name: "Málmur", gloss: "metal", tree: "berg", gen: 4, maxLevel: 10, needs: ["deigla", "sindur"],
    effect: "Grade, strongest", later: true,
    blurb: "The finished stuff — not the ore, not the bloom. The top of what the ground will give." },
  { id: "eldsmidi", name: "Eldsmíði", gloss: "fire-forging", tree: "berg", gen: 4, maxLevel: 10, needs: ["deigla"],
    effect: "Hero equipment quality", later: true,
    blurb: "Working the metal hot. Where mined ore stops being a resource and becomes a jarl's gear." },
  { id: "steypa", name: "Steypa", gloss: "casting", tree: "berg", gen: 4, maxLevel: 10, needs: ["sindur"],
    effect: "Rare-metal conversion", later: true,
    blurb: "Pouring rather than hammering. Shapes an edge cannot make." },

  { id: "bergrisi", name: "Bergrisi", gloss: "the mountain-giant", tree: "berg", gen: 5, maxLevel: 5, needs: ["malmur", "eldsmidi", "steypa"],
    effect: "The deepest workings", later: true,
  ...
  // ---- Hernaður — warfare ---------------------------------------------
  { id: "skjaldborg", name: "Skjaldborg", gloss: "the shield-wall", tree: "her", gen: 1, maxLevel: 5, needs: [],
  ...
  { id: "hamremmi", name: "Hamremmi", gloss: "the berserk fury", tree: "her", gen: 1, maxLevel: 5, needs: [],
  ...
  { id: "bogfimi", name: "Bogfimi", gloss: "bow-skill", tree: "her", gen: 1, maxLevel: 5, needs: [],
    effect: "Archer attack",
    blurb: "Drawing to the ear and loosing without aiming. A winter's practice for one second of use." },
  { id: "reidmennska", name: "Reiðmennska", gloss: "horsemanship", tree: "her", gen: 1, maxLevel: 5, needs: [],
  ...
  { id: "brynja", name: "Brynja", gloss: "the mail shirt", tree: "her", gen: 1, maxLevel: 5, needs: [],
    effect: "All-troop defence",
    blurb: "Riveted rings, worth a farm. Everyone lives slightly longer." },

  { id: "sverdsegg", name: "Sverðsegg", gloss: "the sword-edge", tree: "her", gen: 2, maxLevel: 10, needs: ["skjaldborg", "hamremmi"],
  ...
  { id: "orvaroddr", name: "Örvaroddr", gloss: "the arrowhead", tree: "her", gen: 2, maxLevel: 10, needs: ["bogfimi"],
    effect: "Archer attack, stronger",
    blurb: "The head, not the shaft. What it is shaped to get through decides what it is for." },
  { id: "sodull", name: "Söðull", gloss: "the saddle", tree: "her", gen: 2, maxLevel: 10, needs: ["reidmennska"],
  ...
  { id: "hringabrynja", name: "Hringabrynja", gloss: "ring-mail", tree: "her", gen: 2, maxLevel: 10, needs: ["brynja"],
    effect: "All-troop defence, stronger",
    blurb: "Mail made properly: every ring riveted, not butted. Four times the work, and it holds." },

  { id: "vopnfimi", name: "Vopnfimi", gloss: "weapon-skill", tree: "her", gen: 3, maxLevel: 10, needs: ["sverdsegg"],
  ...
  { id: "almur", name: "Álmur", gloss: "elm, the bow-wood", tree: "her", gen: 3, maxLevel: 10, needs: ["orvaroddr"],
  ...
  { id: "beisli", name: "Beisli", gloss: "the bridle", tree: "her", gen: 3, maxLevel: 10, needs: ["sodull"],
    effect: "Rider handling",
    blurb: "Bit, cheekpieces and reins. Control rather than power, which is what a Rider needs." },
  { id: "spangabrynja", name: "Spangabrynja", gloss: "splint armour", tree: "her", gen: 3, maxLevel: 10, needs: ["hringabrynja"],
  ...
  { id: "atgeir", name: "Atgeir", gloss: "the halberd", tree: "her", gen: 4, maxLevel: 10, needs: ["vopnfimi", "almur"],
  ...
  { id: "hlifskjoldur", name: "Hlífskjöldur", gloss: "the shield over another", tree: "her", gen: 4, maxLevel: 10, needs: ["spangabrynja", "beisli"],
  ...
  { id: "gardur", name: "Garður", gloss: "the enclosure", tree: "vorn", gen: 2, maxLevel: 10, needs: ["diki"],
    effect: "Wall durability",
    blurb: "The turf-and-stone dyke around what is yours. Half the word for a farm is this wall." },
  { id: "saralaekning", name: "Sáralækning", gloss: "wound-healing", tree: "vorn", gen: 2, maxLevel: 10, needs: ["grasalaekning"],
  ...
  { id: "varda", name: "Varða", gloss: "the cairn", tree: "vorn", gen: 3, maxLevel: 10, needs: ["vardeldur"],
  ...
  { id: "vigskord", name: "Vígskörð", gloss: "the battlements", tree: "vorn", gen: 3, maxLevel: 10, needs: ["gardur"],
  ...
  { id: "laeknishendur", name: "Læknishendur", gloss: "healing hands", tree: "vorn", gen: 3, maxLevel: 10, needs: ["saralaekning"],
  ...
  { id: "virki", name: "Virki", gloss: "the stronghold", tree: "vorn", gen: 4, maxLevel: 10, needs: ["vigskord", "varda"],
    effect: "Hall defence, strongest",
    blurb: "Not a castle — a defended place. The last ring of what a hall can do for itself." },

  { id: "fridland", name: "Friðland", gloss: "the place of peace", tree: "vorn", gen: 5, maxLevel: 10, needs: ["virki", "laeknishendur"],
  ...
  // ---- Sigling — the sailing ------------------------------------------
  { id: "kjolur", name: "Kjölur", gloss: "the keel", tree: "sigling", gen: 1, maxLevel: 5, needs: [],
    effect: "Ship durability",
    blurb: "One timber down the length of the hull. Everything else is hung off this." },
  { id: "segl", name: "Segl", gloss: "the sail", tree: "sigling", gen: 1, maxLevel: 5, needs: [],
    effect: "Sea speed",
    blurb: "A square of homespun on a yard. It arrived late in the North and changed what far meant." },
  { id: "ar", name: "Ár", gloss: "the oar", tree: "sigling", gen: 1, maxLevel: 5, needs: [],
  ...
  { id: "sud", name: "Súð", gloss: "the strakes", tree: "sigling", gen: 2, maxLevel: 10, needs: ["kjolur"],
  ...
  { id: "knorr", name: "Knörr", gloss: "the cargo ship", tree: "sigling", gen: 2, maxLevel: 10, needs: ["kjolur", "segl"],
  ...
  { id: "skeid", name: "Skeið", gloss: "the warship", tree: "sigling", gen: 2, maxLevel: 10, needs: ["kjolur", "ar"],
  ...
  { id: "reidi", name: "Reiði", gloss: "the rigging", tree: "sigling", gen: 2, maxLevel: 10, needs: ["segl"],
  ...
  { id: "naust", name: "Naust", gloss: "the boat shed", tree: "sigling", gen: 3, maxLevel: 10, needs: ["sud", "knorr"],
  ...
  { id: "styri", name: "Stýri", gloss: "the steering oar", tree: "sigling", gen: 3, maxLevel: 10, needs: ["ar", "reidi"],
  ...
  { id: "solarsteinn", name: "Sólarsteinn", gloss: "the sunstone", tree: "sigling", gen: 4, maxLevel: 10, needs: ["styri"],
  ...
  { id: "hafsigling", name: "Hafsigling", gloss: "the open crossing", tree: "sigling", gen: 4, maxLevel: 10, needs: ["styri", "naust"],
    effect: "Voyage range",
    blurb: "Leaving the coast behind on purpose and sailing west with nothing to steer by for days." },

  { id: "landnam", name: "Landnám", gloss: "the land-taking", tree: "sigling", gen: 5, maxLevel: 10, needs: ["solarsteinn", "hafsigling"],
  ...
  { id: "leidangr", name: "Leiðangr", gloss: "the naval levy", tree: "viking", gen: 1, maxLevel: 5, needs: [],
  ...
  { id: "strandhogg", name: "Strandhögg", gloss: "the shore-raid", tree: "viking", gen: 1, maxLevel: 5, needs: [],
  ...
  { id: "hertogi", name: "Hertogi", gloss: "the war-leader", tree: "viking", gen: 2, maxLevel: 10, needs: ["leidangr"],
    effect: "March speed and capacity",
    blurb: "The one who leads the levy out. Not a rank — a job, given for a season." },
  { id: "skipalid", name: "Skipalið", gloss: "the fleet", tree: "viking", gen: 2, maxLevel: 10, needs: ["leidangr"],
  ...
  { id: "herfang", name: "Herfang", gloss: "war-booty", tree: "viking", gen: 2, maxLevel: 10, needs: ["strandhogg"],
    effect: "Loot carried home",
    blurb: "What the raid actually brings back, after what was dropped in the rush to the boats." },

  { id: "svinfylking", name: "Svínfylking", gloss: "the boar's snout", tree: "viking", gen: 3, maxLevel: 1, needs: ["hertogi"],
  ...
  { id: "ransferd", name: "Ránsferð", gloss: "the plundering voyage", tree: "viking", gen: 3, maxLevel: 10, needs: ["herfang"],
    effect: "Raid range",
    blurb: "Going further for it. The difference between robbing a neighbour and being a problem for a kingdom." },
  { id: "vigfimi", name: "Vígfimi", gloss: "skill at arms", tree: "viking", gen: 3, maxLevel: 10, needs: ["herfang", "hertogi"],
    effect: "Attack while raiding",
    blurb: "Being good at the part everyone hopes will be short." },

  { id: "herskjoldur", name: "Herskjöldur", gloss: "the war-shield", tree: "viking", gen: 4, maxLevel: 10, needs: ["svinfylking", "ransferd"],
  ...
  { id: "undanhald", name: "Undanhald", gloss: "the withdrawal", tree: "viking", gen: 4, maxLevel: 10, needs: ["vigfimi", "skipalid"],
  ...
  { id: "fraegdarfor", name: "Frægðarför", gloss: "the famous journey", tree: "viking", gen: 5, maxLevel: 10, needs: ["herskjoldur", "undanhald"],
  ...
  { id: "hirdmadur", name: "Hirðmaður", gloss: "the retainer", tree: "hird", gen: 1, maxLevel: 5, needs: [],
  ...
  { id: "mali", name: "Máli", gloss: "the wage", tree: "hird", gen: 1, maxLevel: 5, needs: [],
  ...
  { id: "eidr", name: "Eiðr", gloss: "the oath", tree: "hird", gen: 2, maxLevel: 10, needs: ["hirdmadur"],
  ...
  { id: "handgenginn", name: "Handgenginn", gloss: "gone into the hand", tree: "hird", gen: 2, maxLevel: 10, needs: ["hirdmadur", "mali"],
  ...
  { id: "gjafir", name: "Gjafir", gloss: "gifts", tree: "hird", gen: 3, maxLevel: 10, needs: ["eidr"],
  ...
  { id: "merkismadur", name: "Merkismaður", gloss: "the standard-bearer", tree: "hird", gen: 3, maxLevel: 10, needs: ["eidr"],
  ...
  { id: "stallari", name: "Stallari", gloss: "the marshal", tree: "hird", gen: 3, maxLevel: 10, needs: ["handgenginn"],
  ...
  { id: "drengskapur", name: "Drengskapur", gloss: "honour, valour", tree: "hird", gen: 4, maxLevel: 10, needs: ["merkismadur", "stallari"],
  ...
  { id: "fylgd", name: "Fylgd", gloss: "the following", tree: "hird", gen: 4, maxLevel: 10, needs: ["gjafir", "stallari"],
  ...
  { id: "sersveit", name: "Sérsveit", gloss: "the chosen band", tree: "hird", gen: 5, maxLevel: 1, needs: ["drengskapur", "fylgd"],
